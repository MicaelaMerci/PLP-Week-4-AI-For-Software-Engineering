...
Answer:
-Supervised learning uses labeled data — examples of code that are already marked as buggy or clean. The model learns from these examples to predict whether new code contains bugs. This approach is accurate when large, high-quality labeled datasets are available.
